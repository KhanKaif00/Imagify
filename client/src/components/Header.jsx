...
const Header = () => {
  return (
    <div className="flex flex-col justify-center items-center tedxt-center my-20 ">
      ...
      <h1 className="text-4xl max-w-[300px] sm:text-7xl sm:max-w-[590px] mx-auto mt-10 text-center">Turn text to <span className="text-blue-600">image</span>  in secons.</h1>
     <p className="textcenter max-w-xl mx-auto mt-5">  
